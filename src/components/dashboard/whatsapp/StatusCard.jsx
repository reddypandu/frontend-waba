...
const statusConfig = {
  ...
  test_number: {
    ...
    badgeLabel: "Meta test number",
    title: "Meta temporary test number",
    description: "This is a temporary display/test number provided by Meta.\nTest numbers are for development only and cannot send real messages.\nTo enable real messaging, connect an actual WhatsApp Business number.",
  },
  connecting: {
    icon: Loader2,
  ...
  action_required: {
    ...
    description: "Register this phone number using the registration API or contact your Meta partner to register the phone number.",
  },
  pending_partner: {
    icon: Clock,
    iconClass: "text-warning",
    ...
    badgeClass: "bg-warning/10 text-warning border-warning/20",
    badgeLabel: "Pending",
    title: "Phone number pending registration",
    description: "Meta requires phone number registration to complete setup.\nPlease register this phone number using the registration API or contact your Meta partner.",
  },
  not_connected: {
    icon: WifiOff,
