...
const EditorSidebar = ({ fabricRef, setSelectedObject, selectedObject }) => {
  ...
  const tabs = [
    ...
    { id: "elements", icon: Sparkles, label: "Graphics" },
    { id: "media", icon: Image, label: "Uploads" },
    { id: "text", icon: Type, label: "Text" },
    { id: "layers", icon: Layers, label: "Layers" },
    { id: "properties", icon: Plus, label: "Properties" },
      ...
      <div className="flex border-b border-border bg-muted/30 p-1 m-2 rounded-lg">
        {tabs.map((tab) => (
          <button
            ...
            title={tab.label}
            className={`flex-1 flex flex-col items-center justify-center gap-1 py-1.5 rounded-md text-[9px] font-bold transition-all ${
              activeTab === tab.id
