...
import { Phone, CheckCircle2, AlertCircle, Zap, Shield, ArrowRight, ExternalLink, RefreshCw, Wifi, Settings2, Trash2, QrCode, Clock, Loader2 } from "lucide-react";
...
const WhatsAppSetup = () => {
  ...
  const getRegistrationStatus = () => {
    ...
    if (meta_wa_status === "action_required" && registration_error) return "failed";
      ...
      <div className="space-y-6 max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground font-mono">{waAccount?.phone_number || "Number registered"}</p>
                    <p className="text-xs text-muted-foreground mt-0.5">Status: <span className="font-bold capitalize text-emerald-600">Connected & Verified</span></p>
                  </div>
                </div>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex items-center gap-4 flex-1">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="text-lg font-bold text-foreground">Registration Failed</h3>
                    ...
                    <p className="text-xs text-red-600 mt-1 font-semibold break-words">
                      {waAccount?.registration_error || "Registration with Meta API failed. Please try again."}
                    </p>
                    {waAccount?.last_registration_attempt && (
                      <p className="text-xs text-muted-foreground mt-1">
                        Last attempt: {new Date(waAccount.last_registration_attempt).toLocaleString()}
                      </p>
                    )}
                  </div>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex items-center gap-4 flex-1">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="text-lg font-bold text-foreground">Registration Pending</h3>
                      <Badge className="bg-amber-100 text-amber-700 border-amber-200 text-[10px] font-bold">
                        IN PROGRESS
                      </Badge>
                    </div>
                    <p className="text-sm text-muted-foreground font-mono">{waAccount?.phone_number || "Number not yet registered"}</p>
            ...
            <CardContent className="p-6">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="text-lg font-bold text-foreground">Checking Status...</h3>
                    </div>
                    <p className="text-sm text-muted-foreground">Syncing registration status with Meta API...</p>
                  </div>
                </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          {waAccount?.last_registration_attempt && (
            <InfoCard 
              label="Last Attempt" 
              value={new Date(waAccount.last_registration_attempt).toLocaleString()}
            />
          )}
        </div>
