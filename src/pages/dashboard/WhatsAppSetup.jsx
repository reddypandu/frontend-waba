...
const WhatsAppSetup = () => {
  ...
  const handleManualSave = async () => {
    ...
    try {
      ...
      await apiPost("/api/admin/businesses", {
      ...
      <div className="space-y-6 max-w-4xl mx-auto">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Manage your WhatsApp Business API connection.
            </p>
          </div>
          <Button
            variant="outline"
        ...
        {registrationStatus === "connected" ? (
            ...
            <CardContent className="p-6">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex items-center gap-4 flex-1">
                  <div className="w-14 h-14 rounded-2xl bg-red-100 flex items-center justify-center shadow-inner shrink-0">
                ...
                <div className="flex gap-2 flex-wrap shrink-0">
                  <Button
                    ...
                    disabled={isRetrying || retryRegistrationMutation.isPending}
                    size="sm"
                    className="rounded-xl"
                  >
                    {isRetrying || retryRegistrationMutation.isPending ? (
                      <>
          ...
          <Card className="border-amber-500/30 bg-gradient-to-br from-amber-50/50 to-card shadow-sm">
            <CardContent className="p-6">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex items-center gap-4 flex-1">
                  <div className="w-14 h-14 rounded-2xl bg-amber-100 flex items-center justify-center shadow-inner shrink-0">
                ...
                <div className="flex gap-2 flex-wrap shrink-0">
                  ...
                  >
                    {isRetrying || retryRegistrationMutation.isPending ? (
                      ...
                      <>
                        <RefreshCw className="h-4 w-4 mr-1.5" /> Force Retry
                      </>
                    )}
                  </Button>
                </div>
          ...
          <Card className="border-slate-300/30 bg-gradient-to-br from-slate-50/50 to-card shadow-sm">
            <CardContent className="p-6">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Syncing registration status with Meta API...
                    </p>
                  </div>
                </div>
                <Button
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <InfoCard
            ...
            value={waAccount?.webhook_verified ? "Yes ✅" : "Not yet"}
          />
          <InfoCard
            label="Meta Status"
            value={waAccount?.meta_wa_status || "pending"}
            badge
          />
          {waAccount?.registration_attempt_count > 0 && (
            <InfoCard
              label="Registration Attempts"
              value={`${waAccount.registration_attempt_count} attempt${waAccount.registration_attempt_count !== 1 ? "s" : ""}`}
            />
          )}
          {waAccount?.last_registration_attempt && (
            <InfoCard
          ...
          <Card className="shadow-sm border-border/50">
            ...
            <CardContent className="space-y-3">
              <Alert>
                ...
                <AlertTitle>
                  One-time setup: Configure webhook in Meta App Dashboard
                </AlertTitle>
                <AlertDescription className="text-xs mt-1">
                  This is a <strong>one-time platform-level setup</strong>. Once
                  configured, all users are covered automatically.
                  <br />
                  <br />
                  Webhook URL:{" "}
                  ...
                  <code className="font-mono bg-muted px-1.5 py-0.5 rounded text-primary font-bold">
                    {import.meta.env.VITE_WEBHOOK_VERIFY_TOKEN || "Set in .env"}
                  </code>
                </AlertDescription>
              </Alert>
              <p className="text-[10px] text-muted-foreground mt-2">
                This notice disappears automatically once Meta verifies the
                webhook.
              </p>
              <Button
                variant="outline"
              ...
              >
                <ExternalLink className="h-4 w-4 mr-2" /> Open Meta Developer
                Console
              </Button>
            </CardContent>
          </Card>
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div>
        ...
        <p className="text-muted-foreground">
          Connect your WhatsApp Business API to start sending messages.
        </p>
      </div>
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                The easiest way to connect. Authorize via Meta Embedded Signup
                in seconds.
              </p>
            </div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                For developers. Provide your Phone Number ID, WABA ID, and
        ...
        <div className="space-y-4">
          ...
          <Card className="shadow-sm">
            <CardHeader>
              ...
              <CardDescription>
                Enter your WhatsApp Business credentials from the Meta Developer
                Console.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-5">
              ...
              >
                ...
                <AlertDescription className="text-xs text-amber-700">
                  This requires a Meta Developer account with WhatsApp Business
                  API access. Get your credentials from{" "}
                  <a
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Found in Meta Developer Console → App → WhatsApp → API Setup
                  </p>
                </div>

                <div className="space-y-2">
                  <Label htmlFor="waba_id" className="font-bold text-sm">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setManualForm((f) => ({ ...f, waba_id: e.target.value }))
                    }
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="access_token" className="font-bold text-sm">
                  ...
                  />
                  <p className="text-xs text-muted-foreground">
                    Use a System User token for production. Never use a personal
                    token.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 p-4 rounded-xl bg-muted/50 border">
                ...
                <p className="text-xs text-muted-foreground">
                  Your credentials are encrypted at rest and never shared with
                  third parties.
                </p>
              </div>
  ...
  <div className="flex items-start justify-between p-4 rounded-xl border bg-card shadow-sm gap-3">
    <div className="min-w-0">
      ...
      {badge ? (
        ...
        <p
          className={`text-sm font-bold text-foreground truncate ${mono ? "font-mono text-xs" : ""}`}
        >
          {value || "—"}
        </p>
      )}
